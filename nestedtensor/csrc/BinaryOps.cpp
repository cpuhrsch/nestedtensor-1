...
Tensor NestedTensor_add_Tensor(
  ...
  if (is_nested_tensor_impl(self) && is_nested_tensor_impl(other)) {
    ...
    // std::cout << "self_efficient_nested_size.sizes(): " << self_efficient_nested_size.sizes() << std::endl;
    // std::cout << "other_efficient_nested_size.sizes(): " << other_efficient_nested_size.sizes() << std::endl;
