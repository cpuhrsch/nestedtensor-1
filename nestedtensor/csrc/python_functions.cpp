...
NestedTensor interpolate(
  ...
  auto leaves_count = size_t(
      reduce<decltype(fn), int64_t, at::Tensor>(input.get_structure(), fn, 0));
...
void add_functions(pybind11::module m) {
  m.def(
      ...
      [](at::Tensor input_,
        ...
        if (size.has_value()) {
          return wrap_nested_tensor(interpolate(
      ...
      [](at::Tensor input_,
        ...
        if (size.has_value()) {
          ...
          return wrap_nested_tensor(
              interpolate(input, sizes, c10::nullopt, mode, align_corners));
        }
  ...
  m.def(
      ...
      [](at::Tensor input_,
        ...
        return wrap_nested_tensor(cross_entropy(
            input,
            target,
            weight,
            size_average,
