...
from third_party.pytorch.tools.build_pytorch_libs import build_caffe2
from third_party.pytorch.tools.setup_helpers.env import (IS_WINDOWS, IS_DARWIN, IS_LINUX,
                                                         check_env_flag, build_type)
from third_party.pytorch.tools.setup_helpers.cmake import CMake
...
# cwd = "third_party/pytorch"
# print("CWD: ", cwd)
lib_path = os.path.join(cwd, "third_party", "pytorch", "torch", "lib")
third_party_path = os.path.join(cwd, "third_party", "pytorch", "third_party")
...
version = open('third_party/pytorch/version.txt', 'r').read().strip()
sha = 'Unknown'
...
def build_deps():
    ...
    sym_files = ['third_party/pytorch/tools/shared/_utils_internal.py']
    orig_files = ['third_party/pytorch/torch/_utils_internal.py']
...
def configure_extension_build():
    ...
    main_link_args = []
    main_sources = ["third_party/pytorch/torch/csrc/stub.c"]
